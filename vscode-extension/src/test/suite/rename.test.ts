...
suite('Rename Test Suite', () => {
    ...
    test('Rename function block identifier', async function() {
        ...
        console.log('Function block identifier rename works');
    });
    ...
    test('Rename if statement block identifiers', async function() {
        ...
        console.log('If statement block identifiers rename works');
    });
    ...
    test('Rename while loop block identifiers', async function() {
        ...
        console.log('While loop block identifiers rename works');
    });
    ...
    test('Rename namespace block identifiers', async function() {
        ...
        console.log('Namespace block identifiers rename works');
    });
    ...
    test('Rename struct block identifiers', async function() {
        ...
        console.log('Struct block identifiers rename works');
    });
    ...
    test('Rename on non-block identifier returns nothing', async function() {
        ...
        try {
            ...
            // It's expected that rename might throw an error or return null
            // for non-renameable positions
            console.log('Rename correctly rejected non-block identifier');
        }
        
        console.log('Rename on non-block identifier correctly returns nothing');
    });
    ...
    test('Rename nested block identifiers correctly', async function() {
        ...
        console.log('Nested block identifiers rename correctly');
    });
    ...
    test('Rename all occurrences when multiple blocks share name', async function() {
        ...
        console.log('Multiple blocks with same name all get renamed');
    });
    ...
    test('Rename command integration with F2', async function() {
        ...
        console.log('Rename command (F2) integration works');
    });
    ...
    test('Rename struct name should correctly update block identifier', async function() {
        ...
        // Log the actual edit for debugging
        console.log('Block ID edit:', {
            line: blockIdEdit.range.start.line,
            startChar: blockIdEdit.range.start.character,
            endChar: blockIdEdit.range.end.character,
            newText: blockIdEdit.newText
        });
        ...
        console.log('Struct name rename correctly updates block identifier');
    });
    ...
    test('Linked editing for struct name with block identifier', async function() {
        ...
        console.log('Linked editing for struct with block identifier works');
    });
