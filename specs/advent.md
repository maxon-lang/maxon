...
module {
  ...
  try_0.otherwise:
    ...
    arm64.mov x23, x0
    arm64.str x20, [x23, #40] (8b)
    arm64.adrp_add_rdata x0, __istr_7
    arm64.ldr x0, [x29, #16]
    arm64.str x0, [x23, #0] (8b)
    arm64.str x20, [x23, #8] (8b)
    arm64.mov x0, #-2
    arm64.str x0, [x23, #16] (8b)
    arm64.mov x0, #1
    arm64.str x0, [x23, #24] (8b)
    arm64.str x20, [x23, #32] (8b)
    ...
    arm64.str x23, [x24, #0] (8b)
    arm64.mov x0, #1
    arm64.str x0, [x24, #8] (8b)
    arm64.mov x23, x24
  try_0.merge:
    arm64.mov x0, x23
...
module {
  ...
  try_0.otherwise:
    %57 = mir.call @__mm_decref_maybenull_helper(%48)
    ...
    %51 = mir.call @stdlib.__mm_alloc_needzero(%21, %22, %50)
    %54 = mir.call @stdlib.__mm_incref(%51)
    mir.store %14, %51, 0 width: qword
    %23 = mir.mov_imm 1 : i64
    mir.store %23, %51, 8 width: qword
    mir.br try_0.merge(%51)
  try_0.merge(%38: i64):
    %25, %26 = mir.try_call @stdlib.__int_fromString(%38)
    %55 = mir.call @__mm_decref_maybenull_helper(%38)
    %28 = mir.cmp ne, %26, %0
  ...
  guard_0:
    ...
    mir.ret %35
  guard_0.after:
    %53 = mir.mov_imm 3 : i64
    mir.ret %53
  __rc_edge_11_0:
    %58 = mir.call @stdlib.__mm_incref(%41)
    %59 = mir.call @__mm_decref_maybenull_helper(%2)
