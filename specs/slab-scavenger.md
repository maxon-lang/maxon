...
(64 KiB) is a whole multiple of every page size the compiler's lanes have, which is what makes one
...
```
panic at SlabRuntime.maxon:387: slab runtime: the allocator's state region needs 69 chunk(s) and an
