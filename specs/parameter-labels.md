...
```
```maxoncstderr
error E3005: specs/fragments/parameter-labels/error-missing-param-name.test:6:12: Second and subsequent arguments must be named. Use 'name: value' syntax
```
...
```
```maxoncstderr
error E3003: specs/fragments/parameter-labels/error-unknown-param-name.test:6:26: unknown parameter name: 'person'
```
