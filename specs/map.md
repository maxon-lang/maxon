...
`E3016: Partial interface implementation … expected hash() returns HashValue`. It is recorded here
because this is the program that surfaces it, not because it is this case's subject.
```maxon
