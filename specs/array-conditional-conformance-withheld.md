...
NOTE** — the arrangement the remaining opaque-gate cases print. It is RAISED at `stdlib/Array.maxon:171:32`,
...
note: stdlib/Array.maxon:171:32: raised inside the library, on behalf of the construct above
```
