...
module {
  ...
  entry:
    ...
    x86.xor r8, r8
    x86.mov r9, 8
    x86.lea_func ecx, [__destruct___ManagedMemory]
    x86.mov rdx, rcx
    x86.mov rcx, 32
    x86.mov r8, 1
    x86.call mm_alloc
    ...
    x86.mov ecx, 8
    x86.mov [eax+24], ecx
    x86.lea_func eax, [__destruct_Vec3]
    x86.mov rcx, rax
    x86.mov rdx, rcx
    x86.mov rcx, 16
    x86.mov r8, 2
...
module {
  ...
  func @__destruct___ManagedMemory(ptr: i64) {
  entry:
    %120 = func.param ptr : StdI64
    memref.store %120, __destr_ptr
  ...
  entry:
    ...
    %131 = memref.load_indirect %130+8
