...
module {
  ...
  entry:
    ...
    memref.bulk_zero __stk_8, 4
    %9 = memref.lea __stk_8
    %10 = std.ptr_to_i64 %9
    memref.store %10, __struct_8
    ...
    memref.store_indirect %6, %13+16
    %14 = memref.load __struct_8 : i64
    memref.store_indirect %7, %14+24
    memref.bulk_zero __stk_15, 2
    %16 = memref.lea __stk_15
    %17 = std.ptr_to_i64 %16
    memref.store %17, v
    %18 = memref.load v : i64
    memref.store_indirect %0, %18+0
    %19 = memref.load __struct_8 : i64
    %20 = memref.load v : i64
    memref.store_indirect %19, %20+8
    %21 = memref.lea __arr_0
    %22 = std.ptr_to_i64 %21
    %23 = memref.load v : i64
    %24 = memref.load_indirect %23+8
    memref.store_indirect %22, %24+0
    %25 = arith.constant {value = 3 : i64}
    memref.store_indirect %25, %24+16
  ...
  __range_panic_5:
    %40 = memref.lea_symdata __panic_msg_25
...
module {
  ...
  entry:
    ...
    memref.store_indirect %25, %24+16
    %26 = arith.constant {value = 0 : i64}
    %27 = arith.constant {value = 42 : i64}
    %28 = memref.load v : i64
    func.call @Vec3.set %28, %26, %27
  ...
  __range_panic_5:
    %43 = memref.lea_symdata __panic_msg_27
