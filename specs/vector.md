...
module {
  ...
  __range_ok_5:
    ...
    arm64.ldr x1, [x29, #-40]
    arm64.cmp x1, #0
    arm64.b.eq vector.main.__skip_guarded_75
    arm64.ldr x0, [x29, #-40]
    arm64.bl mm_decref
    arm64.label vector.main.__skip_guarded_75
    arm64.ldr x0, [x29, #-64]
...
module {
  ...
  __range_ok_5:
    ...
    arm64.ldr x1, [x29, #-40]
    arm64.cmp x1, #0
    arm64.b.eq vector.main.__skip_guarded_79
    arm64.ldr x0, [x29, #-40]
    arm64.bl mm_decref
    arm64.label vector.main.__skip_guarded_79
    arm64.ldr x0, [x29, #-64]
    arm64.epilogue stack_size=144
    arm64.ret
  }
