...
```
```maxoncstderr
error E2046: specs/fragments/match-statements/error.match-enum-default.test:12:5: 'default' in a match on enum 'Color' must be followed by 'throws <error>', e.g. 'default throws MyError.unmatched'
```
