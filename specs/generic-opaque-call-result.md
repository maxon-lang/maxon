...
(`specs/generic-opaque-owned-return.md`). Both halves of that sentence are about the CALLER when
...
(`specs/array-declared-record.md`). A sibling call declared `returns Element` therefore has its
