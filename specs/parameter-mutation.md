...
summarise. Refusing every indirect call that carries an immutable argument would refuse working
programs. It is therefore accepted here, and pinned below so the hole is visible rather than assumed.
