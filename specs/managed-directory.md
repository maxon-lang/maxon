...
```
```maxoncstderr
error E3072: specs/fragments/managed-directory/managed-directory.error-direct-construction.test:3:30: '__ManagedDirectory' is a compiler builtin type and cannot be constructed directly
```
