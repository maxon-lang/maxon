...
module {
  ...
  names_loop_0.exit:
    ...
    x64.lea rax, [rip+__layout_Array_Point]
    x64.mov rbx, r9
    x64.add rbx, [rbp+-1040]
    x64.mov rdx, r14
    x64.mov rcx, [rbp+-976]
    x64.call Array.push
    x64.add rbx, [rbp+-1048]
    x64.add rbx, [rbp+-1056]
