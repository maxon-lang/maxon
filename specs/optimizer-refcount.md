...
module {
  ...
  entry:
    ...
    %246 = maxon.field_access .managed %76
    maxon.assign %246 {var = __for_mm_1} {decl = 1 : i1}
    %247 = maxon.struct_var_ref __for_mm_1
    %248 = maxon.field_access .length %247
    maxon.assign %248 {var = __for_len_1} {kind = i64} {decl = 1 : i1}
    %249 = maxon.literal {value = 0 : i64}
    maxon.assign %249 {var = __for_idx_1} {kind = i64} {decl = 1 : i1} {mut = 1 : i1}
    maxon.br iter_0.header
  iter_0.header:
    %250 = maxon.var_ref {var = __for_idx_1} {type = i64}
    %251 = maxon.var_ref {var = __for_len_1} {type = i64}
    %252 = maxon.binop %250, %251 {op = lt}
    maxon.cond_br %252 [then: iter_0, else: iter_0.exit]
  iter_0:
    %253 = maxon.struct_var_ref __for_mm_1
    %254 = maxon.var_ref {var = __for_idx_1} {type = i64}
    %255 = maxon.managed_mem_get %253, %254
    maxon.assign %255 {var = __forin_result_2} {kind = i64} {decl = 1 : i1} {mut = 1 : i1}
    ...
    %256 = maxon.var_ref {var = __for_idx_1} {type = i64}
    %257 = maxon.literal {value = 1 : i64}
    %258 = maxon.binop %256, %257 {op = add}
    maxon.assign %258 {var = __for_idx_1} {kind = i64} {mut = 1 : i1}
...
module {
  ...
  entry:
    ...
    memref.store %714, __interp_managed_ptr_259
    %715 = memref.load __interp_managed_ptr_259 : i64
    %716 = memref.load_indirect %715+0
    %717 = memref.load __interp_managed_ptr_259 : i64
    %718 = memref.load_indirect %717+8
    %719 = arith.constant {value = 21 : i64}
    %720 = std.call_runtime @mm_raw_alloc %719
    memref.store %720, __tostr_buf_720
    %721 = std.call_runtime @maxon_i64_to_string %709, %720
    %722 = memref.load __tostr_buf_720 : i64
    %723 = arith.addi %718, %721
    %724 = arith.constant {value = 16 : i64}
    %725 = func.ref @__destruct_String
    %726 = std.ptr_to_i64 %725
    %727 = arith.constant {value = 6 : i64}
    %728 = std.call_runtime @mm_alloc %724, %726, %727
    memref.store %728, __lit_tmp_219
    %729 = arith.constant {value = 40 : i64}
    %730 = func.ref @__destruct___ManagedMemory
    %731 = std.ptr_to_i64 %730
    %732 = arith.constant {value = 7 : i64}
    %733 = std.call_runtime @mm_alloc %729, %731, %732
    memref.store %733, __interp_managed_219
    %734 = arith.constant {value = 1 : i64}
    %735 = arith.addi %723, %734
    %736 = std.call_runtime @mm_raw_alloc %735
    %737 = arith.constant {value = 0 : i64}
    memref.store %737, __interp_offset_219
    memref.store %736, __interp_buf_219
    memref.store %723, __interp_totallen_219
    memref.store %716, __interp_partbuf_219_0
    memref.store %718, __interp_partlen_219_0
    memref.store %722, __interp_partbuf_219_1
    memref.store %721, __interp_partlen_219_1
    %738 = memref.load __interp_buf_219 : i64
    %739 = memref.load __interp_offset_219 : i64
    %740 = arith.addi %738, %739
    %741 = memref.load __interp_partbuf_219_0 : i64
    %742 = memref.load __interp_partlen_219_0 : i64
    std.memcopy %741, %740, %742
    %743 = memref.load __interp_offset_219 : i64
    %744 = memref.load __interp_partlen_219_0 : i64
    %745 = arith.addi %743, %744
    memref.store %745, __interp_offset_219
    %746 = memref.load __interp_buf_219 : i64
    %747 = memref.load __interp_offset_219 : i64
    %748 = arith.addi %746, %747
    %749 = memref.load __interp_partbuf_219_1 : i64
    %750 = memref.load __interp_partlen_219_1 : i64
    std.memcopy %749, %748, %750
    %754 = memref.load __interp_buf_219 : i64
    %755 = memref.load __interp_totallen_219 : i64
    %756 = arith.addi %754, %755
    %757 = arith.constant {value = 0 : i64}
    memref.store_indirect %757, %756+0
    %758 = memref.load __tostr_buf_720 : i64
    std.call_runtime @mm_raw_free %758
    %759 = memref.load __interp_buf_219 : i64
    %760 = memref.load __interp_totallen_219 : i64
    %761 = arith.constant {value = 1 : i64}
    %762 = arith.constant {value = 0 : i64}
    %763 = memref.load __interp_managed_219 : i64
    memref.store_indirect %759, %763+0
    %764 = memref.load __interp_managed_219 : i64
    memref.store_indirect %760, %764+8
    %765 = memref.load __interp_managed_219 : i64
    memref.store_indirect %760, %765+16
    %766 = memref.load __interp_managed_219 : i64
    memref.store_indirect %761, %766+24
    %767 = memref.load __interp_managed_219 : i64
    memref.store_indirect %762, %767+32
    %768 = memref.load __interp_managed_219 : i64
    %769 = memref.load __lit_tmp_219 : i64
    memref.store_indirect %768, %769+0
    %770 = memref.load __interp_managed_219 : i64
    std.call_runtime @mm_incref %770
    %771 = arith.constant {value = 0 : i64}
    %772 = memref.load __lit_tmp_219 : i64
    memref.store_indirect %771, %772+8
    %773 = memref.load __lit_tmp_219 : i64
    std.call_runtime @mm_incref %773
    %774 = memref.load __lit_tmp_219 : i64
    %775 = func.call @stdlib.String.count %774
    %776 = memref.load __lit_tmp_219 : i64
    std.call_runtime_if_nonnull @mm_decref %776
    func.return %775
  }
  func @__destruct_GraphemeState(ptr: i64) {
  entry:
    %779 = func.param ptr : StdI64
    cf.br done
  done:
    func.return
  }
  ...
  entry:
    %780 = func.param ptr : StdI64
    memref.store %780, __destr_ptr
    %781 = memref.load __destr_ptr : i64
    %782 = memref.load_indirect %781+32
  ...
  entry:
    %783 = func.param ptr : StdI64
    memref.store %783, __destr_ptr
    %784 = memref.load __destr_ptr : i64
    %785 = memref.load_indirect %784+0
    std.call_runtime_if_nonnull @mm_decref %785
    cf.br done
  done:
    func.return
  }
  ...
  entry:
    %787 = func.param ptr : StdI64
    memref.store %787, __destr_ptr
    %788 = memref.load __destr_ptr : i64
    %789 = memref.load_indirect %788+0
    std.call_runtime_if_nonnull @mm_decref %789
    cf.br done
  done:
    func.return
  }
  ...
  entry:
    %790 = func.param ptr : StdI64
    memref.store %790, __destr_ptr
    %791 = memref.load __destr_ptr : i64
    %792 = memref.load_indirect %791+0
  ...
  entry:
    %793 = func.param ptr : StdI64
    memref.store %793, __destr_ptr
    %796 = memref.load __destr_ptr : i64
    %797 = memref.load_indirect %796+16
    %798 = arith.constant {value = -1 : i64}
    %799 = arith.cmpi eq %797, %798
    cf.cond_br %799 [then: slice_cleanup_0, else: check_owned_0]
  slice_cleanup_0:
    %800 = memref.load __destr_ptr : i64
    %801 = memref.load_indirect %800+32
    std.call_runtime_if_nonnull @mm_decref %801
    cf.br skip_buf_0
  check_owned_0:
    %802 = memref.load __destr_ptr : i64
    %803 = memref.load_indirect %802+16
    %804 = arith.constant {value = -2 : i64}
    %805 = arith.cmpi ne %803, %804
    cf.cond_br %805 [then: free_buf_0, else: skip_buf_0]
  free_buf_0:
    %806 = memref.load __destr_ptr : i64
    %807 = memref.load_indirect %806+0
    std.call_runtime @mm_raw_free %807
    cf.br skip_buf_0
  skip_buf_0:
    cf.br done
  done:
  ...
  entry:
    %808 = func.param ptr : StdI64
    memref.store %808, __destr_ptr
    %809 = memref.load __destr_ptr : i64
    %810 = memref.load_indirect %809+0
    %811 = arith.constant {value = 0 : i64}
    %812 = arith.cmpi eq %810, %811
    cf.cond_br %812 [then: case_0, else: check_1]
  case_0:
    %813 = memref.load __destr_ptr : i64
    %814 = memref.load_indirect %813+8
    std.call_runtime_if_nonnull @mm_decref %814
    cf.br done
  check_1:
    %815 = memref.load __destr_ptr : i64
    %816 = memref.load_indirect %815+0
    %817 = arith.constant {value = 1 : i64}
    %818 = arith.cmpi eq %816, %817
    cf.cond_br %818 [then: case_1, else: check_2]
  case_1:
    %819 = memref.load __destr_ptr : i64
    %820 = memref.load_indirect %819+8
    std.call_runtime_if_nonnull @mm_decref %820
    cf.br done
  check_2:
    cf.br done
  done:
  ...
  entry:
    %821 = func.param ptr : StdI64
    memref.store %821, __destr_ptr
    %824 = memref.load __destr_ptr : i64
    %825 = memref.load_indirect %824+16
    %826 = arith.constant {value = -1 : i64}
    %827 = arith.cmpi eq %825, %826
    cf.cond_br %827 [then: slice_cleanup_0, else: check_owned_0]
  slice_cleanup_0:
    %828 = memref.load __destr_ptr : i64
    %829 = memref.load_indirect %828+32
    std.call_runtime_if_nonnull @mm_decref %829
    cf.br skip_buf_0
  check_owned_0:
    %830 = memref.load __destr_ptr : i64
    %831 = memref.load_indirect %830+16
    %832 = arith.constant {value = -2 : i64}
    %833 = arith.cmpi ne %831, %832
    cf.cond_br %833 [then: free_buf_0, else: skip_buf_0]
  free_buf_0:
    %834 = memref.load __destr_ptr : i64
    std.call_runtime @mm_decref_managed_elements %834
    %835 = memref.load __destr_ptr : i64
    %836 = memref.load_indirect %835+0
    std.call_runtime @mm_raw_free %836
    cf.br skip_buf_0
  skip_buf_0:
    cf.br done
  done:
  ...
  entry:
    %837 = func.param ptr : StdI64
    memref.store %837, __destr_ptr
    %838 = memref.load __destr_ptr : i64
    %839 = memref.load_indirect %838+0
    std.call_runtime_if_nonnull @mm_decref %839
    cf.br done
  done:
    func.return
  }
  ...
  entry:
    %840 = func.param ptr : StdI64
    memref.store %840, __destr_ptr
    %843 = memref.load __destr_ptr : i64
    %844 = memref.load_indirect %843+16
    %845 = arith.constant {value = -1 : i64}
    %846 = arith.cmpi eq %844, %845
    cf.cond_br %846 [then: slice_cleanup_0, else: check_owned_0]
  slice_cleanup_0:
    %847 = memref.load __destr_ptr : i64
    %848 = memref.load_indirect %847+32
    std.call_runtime_if_nonnull @mm_decref %848
    cf.br skip_buf_0
  check_owned_0:
    %849 = memref.load __destr_ptr : i64
    %850 = memref.load_indirect %849+16
    %851 = arith.constant {value = -2 : i64}
    %852 = arith.cmpi ne %850, %851
    cf.cond_br %852 [then: free_buf_0, else: skip_buf_0]
  free_buf_0:
    %853 = memref.load __destr_ptr : i64
    %854 = memref.load_indirect %853+0
    std.call_runtime @mm_raw_free %854
    cf.br skip_buf_0
  skip_buf_0:
    cf.br done
  done:
  ...
  entry:
    %855 = func.param ptr : StdI64
    memref.store %855, __destr_ptr
    %856 = memref.load __destr_ptr : i64
    %857 = memref.load_indirect %856+0
    std.call_runtime_if_nonnull @mm_decref %857
    cf.br done
  done:
    func.return
  }
  ...
  entry:
    %858 = func.param ptr : StdI64
    memref.store %858, __destr_ptr
    %861 = memref.load __destr_ptr : i64
    %862 = memref.load_indirect %861+16
    %863 = arith.constant {value = -1 : i64}
    %864 = arith.cmpi eq %862, %863
    cf.cond_br %864 [then: slice_cleanup_0, else: check_owned_0]
  slice_cleanup_0:
    %865 = memref.load __destr_ptr : i64
    %866 = memref.load_indirect %865+32
    std.call_runtime_if_nonnull @mm_decref %866
    cf.br skip_buf_0
  check_owned_0:
    %867 = memref.load __destr_ptr : i64
    %868 = memref.load_indirect %867+16
    %869 = arith.constant {value = -2 : i64}
    %870 = arith.cmpi ne %868, %869
    cf.cond_br %870 [then: free_buf_0, else: skip_buf_0]
  free_buf_0:
    %871 = memref.load __destr_ptr : i64
    std.call_runtime @mm_decref_managed_elements %871
    %872 = memref.load __destr_ptr : i64
    %873 = memref.load_indirect %872+0
    std.call_runtime @mm_raw_free %873
    cf.br skip_buf_0
  skip_buf_0:
    cf.br done
  done:
  ...
  entry:
    %874 = func.param ptr : StdI64
    memref.store %874, __destr_ptr
    %875 = memref.load __destr_ptr : i64
    %876 = memref.load_indirect %875+0
    std.call_runtime_if_nonnull @mm_decref %876
    cf.br done
  done:
    func.return
  }
  ...
  entry:
    %877 = func.param ptr : StdI64
    memref.store %877, __destr_ptr
    %880 = memref.load __destr_ptr : i64
    %881 = memref.load_indirect %880+16
    %882 = arith.constant {value = -1 : i64}
    %883 = arith.cmpi eq %881, %882
    cf.cond_br %883 [then: slice_cleanup_0, else: check_owned_0]
  slice_cleanup_0:
    %884 = memref.load __destr_ptr : i64
    %885 = memref.load_indirect %884+32
    std.call_runtime_if_nonnull @mm_decref %885
    cf.br skip_buf_0
  check_owned_0:
    %886 = memref.load __destr_ptr : i64
    %887 = memref.load_indirect %886+16
    %888 = arith.constant {value = -2 : i64}
    %889 = arith.cmpi ne %887, %888
    cf.cond_br %889 [then: free_buf_0, else: skip_buf_0]
  free_buf_0:
    %890 = memref.load __destr_ptr : i64
    std.call_runtime @mm_decref_managed_elements %890
    %891 = memref.load __destr_ptr : i64
    %892 = memref.load_indirect %891+0
    std.call_runtime @mm_raw_free %892
    cf.br skip_buf_0
  skip_buf_0:
    cf.br done
  done:
  ...
  entry:
    %893 = func.param ptr : StdI64
    memref.store %893, __destr_ptr
    %894 = memref.load __destr_ptr : i64
    %895 = memref.load_indirect %894+0
    std.call_runtime_if_nonnull @mm_decref %895
    cf.br done
  done:
    func.return
  }
...
module {
  ...
  entry:
    ...
    x64.mov [rbp-16], rcx
    x64.test rcx, rcx
    x64.jz __nonnull_skip_77
    x64.call mm_decref
    x64.label __nonnull_skip_77
  ...
  entry:
    ...
    x64.mov [rbp-16], rcx
    x64.test rcx, rcx
    x64.jz __nonnull_skip_78
    x64.call mm_decref
    x64.label __nonnull_skip_78
