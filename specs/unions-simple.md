...
```
```maxoncstderr
error E3030: specs/fragments/unions-simple/error.duplicate-case.test:4:2: duplicate union case: 'red'
```
...
```
```maxoncstderr
error E3034: specs/fragments/unions-simple/error.unknown-union-case.test:8:11: unknown union case: 'green'
```
...
```
```maxoncstderr
error E3031: specs/fragments/unions-simple/error.duplicate-raw-value.test:4:2: duplicate raw value: '200'
```
...
```
```maxoncstderr
error E3032: specs/fragments/unions-simple/error.raw-value-type-mismatch.test:4:2: raw value type mismatch: 'expected int, got float'
```
