...
module {
  ...
  entry:
    %214 = func.param ptr : StdI64
    memref.store %214, __destr_ptr
  ...
  free_buf_0:
    ...
    std.call_runtime @mm_decref_managed_elements %221
    %222 = memref.load __destr_ptr : i64
    %223 = memref.load_indirect %222+0
    std.call_runtime @mm_raw_free %223
    cf.br skip_buf_0
  skip_buf_0:
    cf.br done
  done:
  ...
  entry:
    ...
    %226 = memref.load_indirect %225+8
    std.call_runtime_if_nonnull @mm_decref %226
    cf.br done
  done:
    func.return
  }
