...
⛔⛔ **THE THREE ACCESSORS ARE MEMBERS OF THE VALUE, SO A FIELD HOLDING ONE SERVES THEM TOO — and the compiler
refused that on its own source.** `token.kind.rawValue` (`Compiler/Lexer.maxon:336`, where `kind` is
