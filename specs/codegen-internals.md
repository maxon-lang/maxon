...
module {
  ...
  entry:
    ...
    %21 = memref.load __selfbuf_14.iterIndex : i64
    %22 = memref.load __selfbuf_14.managed.buffer : i64
    %23 = memref.load __selfbuf_14.managed.length : i64
    %24 = memref.load __selfbuf_14.managed.capacity : i64
    %25 = memref.load __selfbuf_14.managed.element_size : i64
    %26 = arith.constant {value = 0 : i64}
    memref.store %25, __selfbuf_27.managed.element_size
    memref.store %24, __selfbuf_27.managed.capacity
    memref.store %23, __selfbuf_27.managed.length
    memref.store %22, __selfbuf_27.managed.buffer
    memref.store %21, __selfbuf_27.iterIndex
