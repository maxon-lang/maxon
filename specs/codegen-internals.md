...
module {
  ...
  entry:
    ...
    %150 = memref.load __destr_ptr : i64
    %151 = memref.load_indirect %150+16
    %152 = arith.constant {value = -1 : i64}
    %153 = arith.cmpi eq %151, %152
    cf.cond_br %153 [then: slice_cleanup_0, else: check_owned_0]
  slice_cleanup_0:
    %154 = memref.load __destr_ptr : i64
    %155 = memref.load_indirect %154+32
    std.call_runtime_if_nonnull @mm_decref %155
    cf.br skip_buf_0
  check_owned_0:
    %156 = memref.load __destr_ptr : i64
    %157 = memref.load_indirect %156+16
    %158 = arith.constant {value = -2 : i64}
