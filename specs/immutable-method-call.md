...
```
```maxoncstderr
error E3063: specs/fragments/immutable-method-call/push-on-let-array-error.test:8:6: cannot pass immutable 'let' variable to function that mutates parameter 'self'
```
...
```
```maxoncstderr
error E3063: specs/fragments/immutable-method-call/set-on-let-array-error.test:8:6: cannot pass immutable 'let' variable to function that mutates parameter 'self'
```
