...
### It is a correctness rule in the compiler, not only a lint

the compiler stores a block's terminator in a **slot** (`IrBlock.terminator`), not as the last op of the
