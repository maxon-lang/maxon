The compiler should check for unused function parameters.

Create a detailed plan to implement this and write it to a file called implementation_plan.md, including a list of tests that need to be updated or added.


Read implementation_plan.md and implement it.
