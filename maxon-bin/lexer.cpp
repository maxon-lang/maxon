...
static const std::unordered_map<std::string, KeywordData> keywords = {
    // Types
    {"int", {KeywordCategory::Type, "Integer type", std::nullopt, [](llvm::LLVMContext &ctx)
             { return llvm::Type::getInt32Ty(ctx); }}},
    {"float", {KeywordCategory::Type, "Floating-point type", std::nullopt, [](llvm::LLVMContext &ctx)
               { return llvm::Type::getDoubleTy(ctx); }}},
    {"ptr", {KeywordCategory::Type, "Pointer type", std::nullopt, [](llvm::LLVMContext &ctx)
             { return llvm::PointerType::get(ctx, 0); }}},
    {"char", {KeywordCategory::Type, "Character type", std::nullopt, [](llvm::LLVMContext &ctx)
              { return llvm::Type::getInt8Ty(ctx); }}},
    {"string", {KeywordCategory::Type, "String type", std::nullopt, [](llvm::LLVMContext &ctx)
                { return llvm::PointerType::get(ctx, 0); }}},
    {"bool", {KeywordCategory::Type, "Boolean type", std::nullopt, [](llvm::LLVMContext &ctx)
