...
int generateGrammar(const std::string &outputFile) {
	...
	json += "                        {\n";
	json += "                            \"name\": \"meta.interpolation.maxon\",\n";
	json += "                            \"begin\": \"\\\\{\",\n";
	json += "                            \"end\": \"\\\\}\",\n";
	json += "                            \"beginCaptures\": { \"0\": { \"name\": \"punctuation.section.interpolation.begin.maxon\" } },\n";
	json += "                            \"endCaptures\": { \"0\": { \"name\": \"punctuation.section.interpolation.end.maxon\" } },\n";
	json += "                            \"patterns\": [\n";
	json += "                                { \"include\": \"#interpolation-content\" }\n";
	json += "                            ]\n";
	json += "                        }\n";
	json += "                    ]\n";
	json += "                }\n";
	...
	json += "                { \"include\": \"#functions\" },\n";
	json += "                { \"include\": \"#types\" },\n";
	json += "                { \"name\": \"variable.other.maxon\", \"match\": \"\\\\b[a-zA-Z_][a-zA-Z0-9_]*\\\\b\" }\n";
	json += "            ]\n";
	json += "        },\n";
	json += "        \"characters\": {\n";
	json += "            \"patterns\": [\n";
