...
pub const Lexer = struct {
    ...
    pub const keyword_map = .{
        ...
        .{ "associatedtype", TokenType.associatedtype, KeywordCategory.other, "Declares an associated type in an interface that conforming types must specify.", false },
        ...
        .{ "extension", TokenType.extension, KeywordCategory.other, "Defines extension methods for an interface.\n\nExample:\n```maxon\nextension Iterable\n    function map(transform (Element) returns Element) returns Array of Element\n        ...\n    end 'map'\nend 'Iterable'\n```", false },
