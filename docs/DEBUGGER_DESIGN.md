...
| P4d ◑ | **Green threads + conditional breakpoints + bp-aware stepping.** SLICED into **P4d-1** (breakpoint semantics ✅) and **P4d-2** (green threads), and P4d-2 further into **P4d-2a** (visibility ✅) and **P4d-2b** (control). ◑ until **P4d-2b AND P4d-GT-STACK** land. | `break … if`; break one GT while others run; `finish` stops at an intervening breakpoint |
