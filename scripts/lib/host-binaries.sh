...
# The downloaded release used to build the tree when the slot above is empty. `scripts/bootstrap.sh`
# puts it there; it is a released compiler, not a second implementation.
