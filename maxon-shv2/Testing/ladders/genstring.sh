...
emit_sites_program() {
	...
	echo "// string ladder: $N sites, mode $MODE — see maxon-shv2/Testing/ladders/genstring.sh"
...
emit_data_program() {
	echo "// string ladder: $N doublings, mode $MODE — see maxon-shv2/Testing/ladders/genstring.sh"
	echo "typealias Int = int(i64.min to i64.max)"
	echo "typealias ExitCode = int(0 to 255)"
	echo ""
