...
emit_sites_program() {
	...
	echo "// grapheme ladder: $N sites, mode $MODE — see maxon-shv2/Testing/ladders/genstring-grapheme.sh"
...
emit_data_program() {
	echo "// grapheme ladder: $N doublings, mode $MODE — see maxon-shv2/Testing/ladders/genstring-grapheme.sh"
	echo "typealias Int = int(i64.min to i64.max)"
	echo "typealias ExitCode = int(0 to 255)"
	echo ""
