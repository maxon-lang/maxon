...
| **P1.2** | `String` + ownership + drops (waves A–D) | ◑ | →611 | #40 · #43 — two bump-masked UAFs (fix before a recycling free-list makes them real) |
