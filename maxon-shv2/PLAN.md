...
| **P1.4b** | errors — `throws`/`try`/`otherwise` | ✅ | 670→792 | **COMPLETE 2026-07-20** (`8b2bec781`). 4 waves — scalar core (`9b9455698`) · managed values (`8ca5225f2`) · managed return (`d16a45f0f`) · boxed-union fields (`807180533`) — + OPEN #54 Slice B2 (union call-arg type-identity, last piece). One disabled test `propagate-throw-through-local-struct` waits on P1.5 #64 |
| **P1.5** | closures + `async` + escape → `shared` | ◑ | A1 →813 | A1 core landed (#67 arm64 open); async R3 substrate landed; residuals #64/#73/#74/#75/#79 (front-end; ✅ #65 implicit-self CLOSED 2026-07-23 `55cafda11`) (runtime ✅ ALL CLOSED: #87+#92 B1c `b9bc8c98b` · #88 drop-reclaim+cancel B2 `eb3c834b0` · #89/B2c await-block-arg-promise · ✅ **#93 runProcess-throws CLOSED 2026-07-23 Design A `7f3721b00`** — scalar `RunProcessError`, rides the B2b async throws ABI, NOT the plan's message-carrying Design B); **P1.5's async/runtime slice is COMPLETE** — only front-end #64/#73/#74/#75/#79 (cross-rung-blocked or deliberate divergences) + #67 arm64 remain, so P1.5 stays ◑ |
