...
| **P1.5** | closures + `async` + escape → `shared` | ◑ | A1 →813 | A1 core landed (#67 arm64 open); async R3 substrate landed; residuals #64/#73/#74/#75/#79 (front-end; ✅ #65 implicit-self CLOSED 2026-07-23 `55cafda11`) + #93 (runtime; ✅ #87+#92 B1c `b9bc8c98b` + ✅ **#88 un-awaited-Promise drop-reclaim+cancel CLOSED 2026-07-23 B2 `eb3c834b0`** + ✅ **#89/B2c await-block-arg-promise CLOSED 2026-07-23 — the same #88 phi-mark work resolved it**); only C (#93 subprocess-stdio) remains |
...
| R3 | GT scheduler + async substrate | ◑ | P1.5 — substrate landed; #93 open (✅ #87+#92 B1c + ✅ #88 drop-reclaim+cancel B2 + ✅ #89/B2c await-block-arg-promise, all CLOSED 2026-07-23) |
