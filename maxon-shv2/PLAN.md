...
**Broaden:** general `Iterable` + associated types · `List`/Json/… · ~~arm64~~ (macOS **scalar core DONE 2026-07-18** — see the Targets row; the arm64 **runtime floor** is its next rung) + wasm (**scalar+floats+globals+heap/String/print/structs/unions DONE 2026-07-18** — WASI Preview2 component, 228/0; Arrays/generics + async + relooper remain) · coverage ·
