...
- **⛔ `regalloc:splitting` IS SUPERLINEAR — measured ×3.9 then ×5.0 per doubling, and it is ~98% of the compile.**
  ...
  is pre-existing and nothing to do with the cascade work. ⚠ **TIME-only ⇒ `scale-test` structurally cannot see it**
