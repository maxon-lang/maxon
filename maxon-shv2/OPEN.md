...
### 45. 🔴 NEW 2026-07-18 (P1.3 Slice 2 review) — **a match-expression `gives` MIX of different types (register-class-compatible) has NO diagnostic and SEGFAULTS. `finalizeMatchMerge` checks register-class, not type identity.**
