...
### 57. 🔴 NEW 2026-07-18 (pre-existing, found by OPEN #54 Slice B review) — **a `float` passed as a NON-FIRST argument PANICS x64 codegen: `X64Backend.maxon:603 emitRegRegMove … rdx→xmm0 crosses register files`. Distinct from #50 (float RETURN) and #56.**
