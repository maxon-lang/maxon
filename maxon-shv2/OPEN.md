...
### 52. 🔴 NEW 2026-07-18 (pre-existing, found by P1.4b Wave 2a review) — **a payload-bearing union declared in a file that sorts AFTER its use PANICS the interner (`classifyUnionPayload:582`).**
