...
### 59. 🔴 NEW 2026-07-19 (pre-existing, cross-cutting; found by #54 Slice C coordinator verification) — **the `ValueTypeTag.named` OVERLOAD leaves an aggregate-vs-scalar hole at the RETURN and CALL-ARG coercion sites (Slice A/B), the twin of the match-merge segfault #54 Slice C closed locally.**
