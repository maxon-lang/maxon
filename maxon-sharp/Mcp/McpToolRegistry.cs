...
///
/// Debug is the first family; refactoring and building follow. A family adds a ROW to
...
internal static class McpToolRegistry {
  ...
  /// </summary>
  private static IReadOnlyList<IReadOnlyList<McpTool>> Families => [DebugTools.Tools];
