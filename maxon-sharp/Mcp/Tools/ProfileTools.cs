...
internal static class ProfileTools {
  ...
  public static IReadOnlyList<McpTool> Tools { get; } = [
    new("profile_run",
      ...
      + "READ THE HONESTY FIELDS BEFORE THE PERCENTAGES: `samples` with `rateHz` and `durationSeconds` "
      + "is what tells 3 readings from 30,000, which look identical once divided; `sparse:true` means "
