...
/// A named group of typed constant values. Unlike union (MlirEnumType), enums have no associated
/// values and no instance methods. Direct == and != comparison is allowed. Supports rawValue,
/// name, fromRawValue(), and fromName().
public class MlirConstantsType(string name, List<MlirEnumCase> cases, MlirType? backingType = null, List<string>? conformingInterfaces = null)
    : MlirEnumType(name, cases, backingType, conformingInterfaces);
