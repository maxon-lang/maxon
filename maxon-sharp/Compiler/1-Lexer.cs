...
public class Lexer(string source) {
  ...
  public static readonly Dictionary<string, KeywordInfo> KeywordMap = new() {
    ...
    { "union", new(TokenType.Union, "Declares a union type with named cases, optional associated values, and methods.\n\nExample:\n```maxon\nunion Result\n    success(value Integer)\n    failure(message String)\nend 'Result'\n```", false) },
    { "enum", new(TokenType.Enum, "Declares an enum type with named cases, optional raw values, and methods. Enums auto-implement Equatable and Hashable.\n\nExample:\n```maxon\nenum Color\n    red\n    green\n    blue\nend 'Color'\n```", false) },
    ...
    { "match", new(TokenType.Match, "Pattern matching statement for unions, enums, and values.", false) },
