...
public class Lexer(string source) {
  ...
  public static readonly Dictionary<string, KeywordInfo> KeywordMap = new() {
    ...
    { "constants", new(TokenType.Constants, KeywordCategory.Other, "Declares a named group of typed constant values with no methods.\n\nExample:\n```maxon\nconstants HttpStatus\n    ok = 200\n    notFound = 404\nend 'HttpStatus'\n```", false) },
    ...
    { "where", new(TokenType.Where, KeywordCategory.Other, "Constrains type parameters to require interface conformance.", false) },
