...
public class Lexer(string source) {
  ...
  public static readonly Dictionary<string, KeywordInfo> KeywordMap = new() {
    ...
    { "enum", new(TokenType.Enum, "Declares an enumeration type with a fixed set of cases.\n\nExample:\n```maxon\nenum Color\n    red\n    green\n    blue\nend 'Color'\n```", false) },
    { "constants", new(TokenType.Constants, "Declares a named group of typed constant values with no methods.\n\nExample:\n```maxon\nconstants HttpStatus\n    ok = 200\n    notFound = 404\nend 'HttpStatus'\n```", false) },
    ...
    { "match", new(TokenType.Match, "Pattern matching statement for enums and values.", false) },
