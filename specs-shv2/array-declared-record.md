...
```
```maxoncstderr
error E2015: <fragment>:22:11: Unsupported: `Array` member 'nosuch' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory; that list IS the surface, so nothing else is served here
```
