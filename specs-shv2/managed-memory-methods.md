...
```
```maxoncstderr
error E2015: <fragment>:4:8: Unsupported: `Array` member 'setLength' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:7:8: Unsupported: `Array` member 'setLength' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:10:12: Unsupported: `Array` member 'setByte' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:8:13: Unsupported: `Array` member 'frobnicate' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:12:13: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:10:11: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:21:14: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:10:18: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:9:27: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:12:15: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:9:11: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:20:12: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:12:12: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:13:18: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:10:44: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:15:15: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:10:19: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:20:17: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
...
```
```maxoncstderr
error E2015: <fragment>:34:25: Unsupported: `Array` member 'length' — P1.7 provides managed/get/set/first/count/isEmpty/push/reserve/resize/clear/insert/append/appendMemory/contains; that list IS the surface, so nothing else is served here
```
