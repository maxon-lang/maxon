...
```
```maxoncstderr
error E3036: <fragment>:3:9: '__Builtins.currentTimeMs' takes exactly 0 argument, but 1 were given
```
...
```
```maxoncstderr
error E3004: <fragment>:3:9: call to undefined function '__Builtins.nope': the '__' prefix names a compiler intrinsic, and no intrinsic of that name exists
```
