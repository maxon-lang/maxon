...
reference reads a two-space marker as an ordinary one. The compiler matched a one-space literal and
...
`marker-spaced-opener.test.maxon`, beside this directory, runs `spec-test` over a copy of it and requires
the case below to be SELECTED, COMPILED and RUN.
