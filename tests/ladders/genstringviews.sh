...
#     two builds swapped into ONE path, interleaved, min-of-7. base = the pre-wave-7 build. ---
#
...
#   both directions). Every mode accumulates into a printed sink and ALL THREE builds agree to the digit
...
#                                             (measured: `b.set(0,88)` leaves the String untouched).
...
#   over 32,768 bytes of mixed 1/2/4-byte content and the base and tip builds print the identical
#   `bytesSum=5169152 cpSum=528236544 u16Sum=461377536`.
