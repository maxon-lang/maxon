...
3. Rebuild and run spec tests if you made any changes to the codebase, and ensure all tests pass. Do the C# tests first then the self hosted tests and the wasm tests.
