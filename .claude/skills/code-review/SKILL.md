...
3. Rebuild and run spec tests if you made any changes to the codebase, ensuring all tests pass. Run the C# tests first, then the self-hosted tests, then the self-hosted wasm target:
...
5. Use `mcp__maxon-dev__fmt` to format all modified maxon files, ensuring consistent code style.
